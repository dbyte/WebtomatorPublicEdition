...
from fixtures.scraper import TEST_SOLEBOX_PRODUCT_HTML_RESPONSE
from fixtures.scraper import TEST_SOLEBOX_SHOP_HTML_RESPONSE
...
# TODO ongoing tests
class SoleboxShopScraperTest(WebtomatorTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        product = Product(url="https://www.solebox.com/en_DE/p/adidas_consortium-craig_green_kontuur_ii-mgsogr%2Fmgsogr%2Fmgsogr-01800380.html")
        shop = Shop(name="Solebox Shop Unit Test", url="https://www.solebox.com", products=[product])
    ...
    def test_run(self):
        # Given
        shop = Shop(name="Solebox Shop unit test", url=str(self.shopHtmlResponsePath))
